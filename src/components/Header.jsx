    ...
    <React.Fragment>
      ...
      <div className="header-container">
        <div className="header-left">
          <Link to="/" className="logo" onClick={() => setActiveView('home')}>
        ...
        <div className="header-actions">
          {!isLoggedIn ? (
            <>
              ...
              <Link to="/signup" className="btn btn-primary signup-header-btn">Sign Up</Link>
            </>
          ) : (
            <div className="user-profile-menu">
              ...
              <div className="dropdown-menu">
                {currentUser?.role === 'admin' ? (
                  <Link to="/admin" className="dropdown-item" onClick={() => setActiveView('admin')}>Admin Dashboard</Link>
                ) : (
                  <Link to="/profile" className="dropdown-item" onClick={() => setActiveView('profile')}>My Bookings</Link>
                )}
                <button 
